...
class CAFormer(nn.Module):
    def __init__(self, img_size=256, in_chans=3,
                 ...
                 dowsample=Downsample, upsample=Upsample,wbset_num=3, **kwargs):
        super().__init__()
        self.in_chansH = in_chans//wbset_num
        self.conv_input = nn.Conv2d(in_chans, wbset_num, kernel_size=1, padding=0)
        ...
        # Input/Output
        self.input_proj = InputProj(in_channel=wbset_num, out_channel=(embed_dim//2), kernel_size=3, stride=1, act_layer=nn.LeakyReLU)
        self.output_proj = OutputProj(in_channel=2*embed_dim, out_channel=wbset_num, kernel_size=3, stride=1)
    ...
    def forward(self, x ,cha_hist,hist_feaure, mask=None):
        # print('.........forward..........')
        # print(cha_hist[0].shape,cha_hist[1].shape,cha_hist[2].shape,cha_hist[3].shape,cha_hist[4].shape,cha_hist[5].shape,cha_hist[6].shape)   
        # print(cha_hist[0])
        # print('hist_feaure',hist_feaure[0].shape)##BLC
        # print('.........forward end..........')
        # Input  Projection
        ...
        # print('cat_y',cat_y.shape,cat_y.dtype)
        #Encoder
