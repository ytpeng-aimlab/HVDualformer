...
#     checkpoint_model = torch.load(r'D:\my_work\checkpoints\mywork_5_30\Histoformer_epoch_.pth') # model.load_state_dict(checkpoint_model['state_dict'])
...
#     optimizer_u.load_state_dict(checkpoint_net_u['optimizer'])
    ...
    for e in range(opt.epochs):
        ...
        if (e+1)>180 or (e+1)%10==0:
                # torch.save(model, os.path.join(opt.save_dir,"Histoformer{}patch.pth".format(e+1)))
                # torch.save(net_u, os.path.join(opt.save_dir,"CAformer{}patch.pth".format(e+1)))     
...
if __name__ == '__main__':
    ...
    parser.add_argument('--epochs', type=int, default=300, help='the starting epoch count')
    ...
    parser.add_argument('--save_dir', type=str, default ='./checkpoints/mywork_5_30d12',  help='save dir')
